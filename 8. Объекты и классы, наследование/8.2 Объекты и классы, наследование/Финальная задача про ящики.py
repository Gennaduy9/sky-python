...
# contains
#
# и метод observe(), который возвращает: Это похоже на ящик размером 30x30 и весом 35кг

# Наследуйте от него класс Container.
# Он будет отличаться наличием метода open(), который возвращает то, что лежит в ящике,
# например: В ящике размером 40x40 и весом 1кг оказалось 4 кг апельсин
